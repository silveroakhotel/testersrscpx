...
export const Route = createFileRoute("/landingpage")({
  head: () => ({
    meta: [
      { title: "Landing Page" },
      { name: "description", content: "Route reserved for the public-facing landing page." },
    ],
  }),
  ...
  return (
    <main className="min-h-dvh bg-white text-slate-950">
      <section className="mx-auto flex min-h-dvh w-full max-w-5xl items-center justify-center px-6 py-16 text-center">
        <div>
          <p className="text-sm font-bold uppercase tracking-[0.18em] text-slate-400">Landing Page</p>
